    ...
    <section className="reviews">
        ...
        <div className="reviews-slider">
            <Swiper className="wrap"
                ...
                <SwiperSlide>
                <div className="box">
                    <img src="/Read-that-book/client1.jpg" alt="" />
                    <h3>john doe</h3>
                 ...
                 <SwiperSlide>
                <div className="box">
                    <img src="/Read-that-book/client2.jpg" alt="" />
                    <h3>john doe</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia porro quis, corporis explicabo, voluptas, temporibus maiores amet sequi voluptate atque ad cum eum ratione facere soluta magnam quasi modi culpa.</p>
                    <div className="stars">
                        <FontAwesomeIcon icon={faStar}/>
                 ...
                 <SwiperSlide>
                <div className="box">
                    <img src="/Read-that-book/client3.jpg" alt="" />
                    <h3>john doe</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia porro quis, corporis explicabo, voluptas, temporibus maiores amet sequi voluptate atque ad cum eum ratione facere soluta magnam quasi modi culpa.</p>
                    <div className="stars">
                        <FontAwesomeIcon icon={faStar}/>
                 ...
                 <SwiperSlide>
                <div className="box">
                    <img src="/Read-that-book/client4.jpg" alt="" />
                    <h3>john doe</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia porro quis, corporis explicabo, voluptas, temporibus maiores amet sequi voluptate atque ad cum eum ratione facere soluta magnam quasi modi culpa.</p>
                    <div className="stars">
                        <FontAwesomeIcon icon={faStar}/>
                 ...
                 <SwiperSlide>
                <div className="box">
                    <img src="/Read-that-book/client5.jpg" alt="" />
                    <h3>john doe</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia porro quis, corporis explicabo, voluptas, temporibus maiores amet sequi voluptate atque ad cum eum ratione facere soluta magnam quasi modi culpa.</p>
                    <div className="stars">
                        <FontAwesomeIcon icon={faStar}/>
